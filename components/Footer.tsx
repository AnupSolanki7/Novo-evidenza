...
const Footer = () => {
  return (
    <footer className="w-full max-w-[1990px] mx-auto px-2 md:px-16 flex-col bg-gradient-to-t from-slate-50 via-slate-100 to-slate-300 flex items-center justify-center py-3">
      <MotionDiv className="px-6 mx-auto  flex justify-start w-full mt-6 ">
        <span className="flex items-center" >
          <Logo />{" "}
          <h2 className="md:text-3xl text-xl w-full text-center font-extrabold text-slate-700">
            VivoClin Research
          </h2>
        </span>
      </MotionDiv>
      <MotionDiv className="px-6 mx-auto flex overflow-hidden flex-col md:flex-row justify-start w-full mt-6 gap-12 md:gap-0 ">
        <div className=" w-full md:w-1/3 justify-start items-start flex flex-col gap-4 ">
          <span className="flex justify-start gap-1 text-slate-700 font-semibold items-start">
            <IoLocationSharp className="text-xl w-6 flex-shrink-0" />
            <p>Near AEC Cross Road , Memnagar, Ahmedabad</p>
          </span>
          {/* <span className="flex justify-start gap-1 text-slate-700 font-semibold items-center">
            <FaPhoneAlt className="text-xl w-6 flex-shrink-0" />
            <span className="text-slate-700 flex justify-start items-center gap-2">
              Call Us:
              <span className="flex gap-2">
                <Link className="text-slate-700" href={"tel:9617330774"}>
                  +91-9617330774
                </Link>
                <Link className="text-slate-700" href={"tel:9974525632"}>
                  +91-9974525632
                </Link>
              </span>
            </span>
          ...
          <span className="flex justify-start gap-1 text-slate-700 font-semibold items-center">
            ...
            <Link
              className="flex-wrap text-slate-700"
        ...
        <div className=" w-full md:w-1/3  justify-start items-start md:items-center flex flex-col gap-4 ">
          <span className="flex flex-col gap-2">
            <span className="border-b-2 text-slate-700 font-semibold ">
              <p>Quick Links</p>
            </span>
            <Link
              className={clsx(
      ...
      <div className="border-t-2 text-slate-700 w-full text-sm mt-6">
