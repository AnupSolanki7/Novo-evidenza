      ...
      <div className="relative mx-auto max-w-[1400px] px-5 sm:px-6 lg:px-10">
        ...
        >
                ...
                <li key={specialty.name}>
                  <button
                    ...
                    className={clsx(
                      ...
                      isActive
                        ? "border-sky-200 bg-white shadow-[0_10px_30px_-14px_rgb(2,30,62,0.35)]"
                        : "border-slate-200/70 bg-white/50 hover:border-sky-200 hover:bg-white"
                    )}
                  >
                    <span
                      className={clsx(
          ...
          <div
            ...
            className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-[#0F172A] to-[#0B132B] p-8 shadow-[0_30px_80px_-30px_rgb(2,30,62,0.55)] sm:p-10"
          >
            <span
              aria-hidden="true"
            ...
            <span className="relative inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-cyan-400 to-teal-400 text-slate-950">
              <ActiveIcon className="h-7 w-7" aria-hidden="true" />
            </span>

            <h3 className="relative mt-6 text-2xl font-bold tracking-tight text-white sm:text-3xl">
