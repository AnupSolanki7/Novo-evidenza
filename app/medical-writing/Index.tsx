          ...
          <div className="flex flex-col-reverse items-center gap-12 md:flex-row md:justify-between">
            <MotionDiv className="w-full md:w-1/2">
              ...
              <p className="mb-8 text-lg leading-relaxed text-gray-700">
                ...
                designed to communicate complex medical and scientific
                information with precision and clarity. Our team of skilled
                professionals ensures the delivery of high-quality, accurate,
                and compliant documents tailored to your specific needs.
              </p>
              <Button
                as={Link}
